...
#ifndef zcommand_h_INCLUDED
#define zcommand_h_INCLUDED
...
extern const char *CONFIG_FILE_OLD;
...
class ZCommand : public ZMode
{
  ...
  private:
    ...
    uint8_t *doStateMachine(uint8_t *buf, uint32_t *bufLen, char **machineState, String *machineQue, char *stateMachine);
    uint8_t *doMaskOuts(uint8_t *buf, uint32_t *bufLen, char *maskOuts);
    ...
    ZResult doBaudCommand(uint32_t vval, uint8_t *vbuf, int vlen);
    ZResult doTransmitCommand(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber, const char *dmodifiers, int *crc8);
    ZResult doLastPacket(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber);
    ZResult doConnectCommand(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber, const char *dmodifiers);
    ZResult doWiFiCommand(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber, const char *dmodifiers);
    ZResult doDialStreamCommand(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber, const char *dmodifiers);
    ZResult doPhonebookCommand(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber, const char *dmodifiers);
    ZResult doAnswerCommand(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber, const char *dmodifiers);
    ZResult doHangupCommand(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber);
    ZResult doEOLNCommand(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber);
    ZResult doInfoCommand(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber);
    ZResult doWebStream(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber, const char *filename, bool cache);
    ZResult doUpdateFirmware(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber);
    ZResult doTimeZoneSetupCommand(uint32_t vval, uint8_t *vbuf, int vlen, bool isNumber);
