...
#ifndef wifiservernode_h_INCLUDED
#define wifiservernode_h_INCLUDED
...
class WiFiServerNode : public WiFiServerSpec
{
  public:
    ...
    WiFiServerNode(uint16_t port, int flagsBitmap);
    bool hasClient();
    ~WiFiServerNode();

    static WiFiServerNode *FindServer(uint16_t port);
