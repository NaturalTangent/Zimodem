...
#ifndef wificlientnode_h_INCLUDED
#define wificlientnode_h_INCLUDED
...
extern WiFiClient *createWiFiClient(bool SSL);
...
extern uint32_t WiFiNextClientId;
extern WiFiClientNode *conns;
extern int checkOpenConnections();
