...
extern bool enableRtsCts;
extern char FBUF[256];
extern int serialDelayMs;

extern void serialOutDeque();
extern int serialOutBufferBytesRemaining();
extern void clearSerialOutBuffer();
